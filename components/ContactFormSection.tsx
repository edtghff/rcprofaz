...
import { contactPhone, contactPhoneRaw } from '@/data/navData'
...
export default function ContactFormSection() {
  ...
  return (
    <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
      {/* Contact Form */}
      <div className="bg-gray-50 p-8 border border-gray-200 animate-slide-in-left">
        <h3 className="text-2xl font-medium text-gray-900 mb-6 tracking-tight">Mesaj göndər</h3>
        {submitted ? (
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            <div>
              <label htmlFor="home-name" className="block text-sm font-medium text-gray-900 mb-2">
              ...
              <input
                ...
                required
                className="w-full px-4 py-2.5 border border-gray-300 focus:ring-1 focus:ring-gray-900 focus:border-gray-900 outline-none text-sm font-light bg-white"
              />
            </div>

            <div>
              <label htmlFor="home-phone" className="block text-sm font-medium text-gray-900 mb-2">
            ...
            <div>
              <label htmlFor="home-email" className="block text-sm font-medium text-gray-900 mb-2">
                E-mail
              </label>
              <input
                type="email"
            ...
            <div>
              <label htmlFor="home-message" className="block text-sm font-medium text-gray-900 mb-2">
              ...
              <textarea
                ...
                required
                rows={5}
                className="w-full px-4 py-2.5 border border-gray-300 focus:ring-1 focus:ring-gray-900 focus:border-gray-900 outline-none text-sm font-light resize-none bg-white"
              />
            </div>
      ...
      <div className="animate-slide-in-right">
        <div className="w-full h-full min-h-[500px] border border-gray-200 overflow-hidden">
          <iframe
